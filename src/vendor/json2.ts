...
(function() {
  ...
  if (typeof Date.prototype.toJSON !== "function") {
    Date.prototype.toJSON = <any>function(key?: any) {
    ...
    numProto.JSON = strProto.JSON = (<any>Boolean).prototype.toJSON = function(
      key?: any,
    ) {
      return this.valueOf();
    };
  ...
  function quote(string: string) {
    ...
    return esc.test(string)
      ? '"' +
          string.replace(esc, function(a: string) {
            let c = (<any>meta)[a];
  ...
  function str(key: string, holder: any): string {
    ...
    if (typeof rep === "function") {
      value = (<Function>rep).call(holder, key, value);
    }
  ...
  if (typeof JSON2.parse !== "function") {
    JSON2.parse = function(text: string, reviver: Function) {
